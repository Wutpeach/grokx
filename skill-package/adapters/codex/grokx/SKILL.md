...
This adapter targets Codex-style native skill discovery.

Preferred install location:

- `~/.agents/skills/grokx/`

Fallback used in some environments:

- `~/.codex/skills/grokx/`

The sibling `agents/openai.yaml` file provides optional UI metadata.
